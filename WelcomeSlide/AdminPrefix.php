...
class HaiPham_WelcomeSlide_AdminPrefix implements XenForo_Route_Interface
{
    ...
    {
        $actions = $router->resolveActionWithIntegerParam($routePath, $request, 'slide_id');
    ...
    {
        return XenForo_Link::buildBasicLinkWithIntegerParam($outputPrefix, $action, $extension, $data, 'slide_id');
    }
}